...
public class Zoom extends Module {
    ...
    private static final int  ZOOM_KEY      = net.lax1dude.eaglercraft.v1_8.internal.KeyboardConstants.KEY_C;
    ...
    public void onUpdate() {
        ...
        boolean holdingZoom = net.lax1dude.eaglercraft.v1_8.Keyboard.isKeyDown(ZOOM_KEY)
                              && mc.inGameHasFocus;
